...
class lruCache_device
{
	...
	public:
		lruCache_device(char * file_name, char * dataset_name, int maxElements, int3 cDim, int cI, int levelC, int nLevelsO, int maxElementsCPU);
